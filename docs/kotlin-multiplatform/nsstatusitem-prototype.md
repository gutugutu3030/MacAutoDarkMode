...
- 実行コード: [`../../src/macosArm64Main/kotlin/com/github/gutugutu3030/autodarkmode/app/Main.kt`](../../src/macosArm64Main/kotlin/com/github/gutugutu3030/autodarkmode/app/Main.kt)

当初このコードは独立した検証実装として扱っていたが、現在は repository root の Gradle project に統合されている。
...
次の 1 本として、production の `SettingsStore` に寄せた更新経路を検証実装に追加した。
...
この検証が通るなら、検証実装は `SettingsView -> SettingsStore -> StatusBarController` に近い 1 本の更新経路を部分的に再現したと言える。
